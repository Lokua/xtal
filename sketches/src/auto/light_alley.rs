...
// use crate::constants::{IG_HEIGHT, IG_WIDTH, WORKING_BPM};

pub static SKETCH_CONFIG: SketchConfig = SketchConfig {
    name: "light_alley",
    display_name: "Light Alley",
...
impl Sketch for LightAlleySketch {
...
pub fn init() -> LightAlleySketch {
    let assets = SketchAssets::from_file(file!());

    LightAlleySketch {
        video_shader_path: assets.wgsl(),
        feedback_shader_path: assets.path("light_alley_feedback.wgsl"),
        video_paths: vec![
